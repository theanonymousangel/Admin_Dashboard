...
export const mockOrders: Order[] = [
  ...
  { id: 'ord-102', customerName: 'John Smith', customerEmail: 'john.smith@example.com', customerPhone: '234-567-8901', customerAddress: '456 Maple Ave, Somecity, USA', products: [{ name: 'Denim Jacket', quantity: 1, size: 'L' }, { name: 'Black Skinny Jeans', quantity: 1, size: '32' }], amount: 169.98, status: 'Shipped', date: '2023-10-25' },
