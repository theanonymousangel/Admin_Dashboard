...
export const mockOrders: Order[] = [
  { id: 'ord-101', customerName: 'Jane Doe', customerEmail: 'jane.doe@example.com', customerPhone: '123-456-7890', customerAddress: '123 Oak St, Anytown, USA', products: [{ name: 'Classic White Tee', quantity: 2, size: 'M', color: 'White' }], amount: 59.98, status: 'Completed', date: '2023-10-26', affiliateUsername: 'fashion_blog' },
  { id: 'ord-102', customerName: 'John Smith', customerEmail: 'john.smith@example.com', customerPhone: '234-567-8901', customerAddress: '456 Maple Ave, Somecity, USA', products: [{ name: 'Denim Jacket', quantity: 1, size: 'L', color: 'Blue' }, { name: 'Black Skinny Jeans', quantity: 1, size: '32', color: 'Black' }], amount: 169.98, status: 'Shipped', date: '2023-10-25', affiliateUsername: 'style_influencer' },
  { id: 'ord-103', customerName: 'Alice Johnson', customerEmail: 'alice.j@example.com', customerPhone: '345-678-9012', customerAddress: '789 Pine Rd, Otherville, USA', products: [{ name: 'Beige Hoodie', quantity: 1, size: 'S', color: 'Beige' }], amount: 59.99, status: 'Pending', date: '2023-10-27', affiliateUsername: 'fashion_blog' },
  { id: 'ord-104', customerName: 'Bob Brown', customerEmail: 'bob.brown@example.com', customerPhone: '456-789-0123', customerAddress: '101 Birch Blvd, Anyplace, USA', products: [{ name: 'Leather Boots', quantity: 1, size: '10', color: 'Black' }], amount: 129.99, status: 'Cancelled', date: '2023-10-24' },
  { id: 'ord-105', customerName: 'Jane Doe', customerEmail: 'jane.doe@example.com', customerPhone: '123-456-7890', customerAddress: '321 Elm St, Anytown, USA', products: [{ name: 'Silk Scarf', quantity: 1, size: 'One Size', color: 'Red' }], amount: 39.99, status: 'Completed', date: '2023-09-12' },
  { id: 'ord-106', customerName: 'Alice Johnson', customerEmail: 'alice.j@example.com', customerPhone: '345-678-9012', customerAddress: '789 Pine Rd, Otherville, USA', products: [{ name: 'Black Skinny Jeans', quantity: 1, size: '30', color: 'Black' }], amount: 79.99, status: 'Completed', date: '2023-08-01' },
];
...
const salesForAffiliate1: AffiliateSale[] = [
    ...
    { id: 'sale-07', productName: 'Black Skinny Jeans', productSize: '32', productColor: 'Black', amount: 350.00, date: new Date(lastMonth.getFullYear(), lastMonth.getMonth(), 10).toISOString(), customerName: 'Emma Brown' },
];
const salesForAffiliate2: AffiliateSale[] = [
    { id: 'sale-04', productName: 'Silk Scarf', productSize: 'One Size', productColor: 'Red', amount: 99.99, date: new Date(today.getFullYear(), today.getMonth(), 2).toISOString(), customerName: 'Ava Jones' },
    ...
    { id: 'sale-06', productName: 'Leather Boots', productSize: '9', productColor: 'Brown', amount: 50.25, date: new Date(lastMonth.getFullYear(), lastMonth.getMonth(), 25).toISOString(), customerName: 'Sophia Miller' },
];
