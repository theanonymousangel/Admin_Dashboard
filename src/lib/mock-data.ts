...
export const mockOrders: Order[] = [
  ...
  { id: 'ord-104', customerName: 'Bob Brown', customerEmail: 'bob.brown@example.com', customerPhone: '456-789-0123', customerAddress: '101 Birch Blvd, Anyplace, USA', products: [{ name: 'Leather Boots', quantity: 1, size: 'L', color: 'Black' }], amount: 129.99, status: 'Cancelled', date: '2023-10-24' },
  { id: 'ord-105', customerName: 'Jane Doe', customerEmail: 'jane.doe@example.com', customerPhone: '123-456-7890', customerAddress: '321 Elm St, Anytown, USA', products: [{ name: 'Silk Scarf', quantity: 1, color: 'Red' }], amount: 39.99, status: 'Completed', date: '2023-09-12' },
  { id: 'ord-106', customerName: 'Alice Johnson', customerEmail: 'alice.j@example.com', customerPhone: '345-678-9012', customerAddress: '789 Pine Rd, Otherville, USA', products: [{ name: 'Black Skinny Jeans', quantity: 1, size: 'S', color: 'Black' }], amount: 79.99, status: 'Completed', date: '2023-08-01' },
];
...
export const mockAffiliates: Affiliate[] = [
  ...
  { id: 'aff-03', username: 'newtrendsco', firstName: 'Alice', lastName: 'Johnson', email: 'trends@newco.com', totalSales: 500, commissionRate: 10, balance: 50, status: 'Inactive', sales: salesForAffiliate3, documents: [], payoutDetails: {}, promotableProductIds: [] },
