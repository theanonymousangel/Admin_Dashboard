...
export const mockOrders: Order[] = [
  { id: 'ord-101', customerName: 'Jane Doe', customerEmail: 'jane.doe@example.com', products: [{ name: 'Classic White Tee', quantity: 2 }], amount: 59.98, status: 'Completed', date: '2023-10-26' },
  { id: 'ord-102', customerName: 'John Smith', customerEmail: 'john.smith@example.com', products: [{ name: 'Denim Jacket', quantity: 1 }, { name: 'Black Skinny Jeans', quantity: 1 }], amount: 169.98, status: 'Shipped', date: '2023-10-25' },
  { id: 'ord-103', customerName: 'Alice Johnson', customerEmail: 'alice.j@example.com', products: [{ name: 'Beige Hoodie', quantity: 1 }], amount: 59.99, status: 'Pending', date: '2023-10-27' },
  { id: 'ord-104', customerName: 'Bob Brown', customerEmail: 'bob.brown@example.com', products: [{ name: 'Leather Boots', quantity: 1 }], amount: 129.99, status: 'Cancelled', date: '2023-10-24' },
];
...
export const mockAffiliates: Affiliate[] = [
  ...
  { id: 'aff-02', username: 'style_influencer', firstName: 'John', lastName: 'Smith', email: 'style@influencer.com', totalSales: 8200, commissionRate: 12, balance: 984, status: 'Active', sales: salesForAffiliate2, documents: [], dateJoined: '2023-03-20' },
  { id: 'aff-03', username: 'newtrendsco', firstName: 'Alice', lastName: 'Johnson', email: 'trends@newco.com', totalSales: 500, commissionRate: 10, balance: 50, status: 'Inactive', sales: salesForAffiliate3, documents: [], dateJoined: '2023-08-10' },
  { id: 'aff-04', username: 'urban_stylist', firstName: 'Bob', lastName: 'Brown', email: 'urban@stylist.com', totalSales: 0, commissionRate: 10, balance: 0, status: 'Pending', sales: salesForAffiliate4, documents: [], dateJoined: '2023-10-28' },
];
