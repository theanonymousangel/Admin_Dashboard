...
export const mockOrders: Order[] = [
  { id: 'ord-101', customerName: 'Jane Doe', customerEmail: 'jane.doe@example.com', customerPhone: '123-456-7890', customerAddress: '123 Oak St, Anytown, USA', products: [{ name: 'Classic White Tee', quantity: 2, size: 'M', color: 'White' }], amount: 5998, status: 'Completed', date: '2025-06-26', affiliateUsername: 'fashion_blog' },
  { id: 'ord-102', customerName: 'John Smith', customerEmail: 'john.smith@example.com', customerPhone: '234-567-8901', customerAddress: '456 Maple Ave, Somecity, USA', products: [{ name: 'Denim Jacket', quantity: 1, size: 'L', color: 'Blue' }, { name: 'Black Skinny Jeans', quantity: 1, size: 'M', color: 'Black' }], amount: 8998, status: 'Shipped', date: '2025-05-25', affiliateUsername: 'style_influencer' },
  { id: 'ord-103', customerName: 'Alice Johnson', customerEmail: 'alice.j@example.com', customerPhone: '345-678-9012', customerAddress: '789 Pine Rd, Otherville, USA', products: [{ name: 'Beige Hoodie', quantity: 1, size: 'S', color: 'Beige' }], amount: 5999, status: 'Pending', date: '2025-06-27', affiliateUsername: 'fashion_blog' },
  { id: 'ord-104', customerName: 'Bob Brown', customerEmail: 'bob.brown@example.com', customerPhone: '456-789-0123', customerAddress: '101 Birch Blvd, Anyplace, USA', products: [{ name: 'Leather Boots', quantity: 1, size: 'L', color: 'Black' }], amount: 12999, status: 'Cancelled', date: '2025-04-24' },
  { id: 'ord-105', customerName: 'Jane Doe', customerEmail: 'jane.doe@example.com', customerPhone: '123-456-7890', customerAddress: '321 Elm St, Anytown, USA', products: [{ name: 'Silk Scarf', quantity: 1, color: 'Red' }], amount: 3999, status: 'Completed', date: '2025-03-12' },
  { id: 'ord-106', customerName: 'Alice Johnson', customerEmail: 'alice.j@example.com', customerPhone: '345-678-9012', customerAddress: '789 Pine Rd, Otherville, USA', products: [{ name: 'Black Skinny Jeans', quantity: 1, size: 'S', color: 'Black' }], amount: 7999, status: 'Completed', date: '2025-02-01' },
];
