...
export const mockOrders: Order[] = [
  { id: 'ord-101', customerName: 'Jane Doe', customerEmail: 'jane.doe@example.com', customerPhone: '123-456-7890', products: [{ name: 'Classic White Tee', quantity: 2 }], amount: 59.98, status: 'Completed', date: '2023-10-26' },
  { id: 'ord-102', customerName: 'John Smith', customerEmail: 'john.smith@example.com', customerPhone: '234-567-8901', products: [{ name: 'Denim Jacket', quantity: 1 }, { name: 'Black Skinny Jeans', quantity: 1 }], amount: 169.98, status: 'Shipped', date: '2023-10-25' },
  { id: 'ord-103', customerName: 'Alice Johnson', customerEmail: 'alice.j@example.com', customerPhone: '345-678-9012', products: [{ name: 'Beige Hoodie', quantity: 1 }], amount: 59.99, status: 'Pending', date: '2023-10-27' },
  { id: 'ord-104', customerName: 'Bob Brown', customerEmail: 'bob.brown@example.com', customerPhone: '456-789-0123', products: [{ name: 'Leather Boots', quantity: 1 }], amount: 129.99, status: 'Cancelled', date: '2023-10-24' },
];
